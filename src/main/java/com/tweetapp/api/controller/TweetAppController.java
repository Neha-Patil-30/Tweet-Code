...
import com.tweetapp.api.security.service.LoginService;
...
public class TweetAppController {
	...
	public ResponseEntity<Object> registerUser(@RequestBody User user) throws PreExsistingUsername {
	...
	@ResponseBody
	@PostMapping("/login")
	public ResponseEntity<TokenResponse> loginUser(@RequestBody User user)
			throws UserNotFoundException, NoSuchAlgorithmException {

		TokenResponse token = loginService.userLogin(user);
	...
	public ResponseEntity<List<User>> searchUser(@PathVariable("username") String username)
			throws UnregisteredUsernameOrPassword {
